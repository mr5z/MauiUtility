...
public class PopupPageNavigation : IPopupPageNavigation
{
	...
	{
		Mopups.Services.MopupService.Instance.Pushed += Mopups_Pushed;
		Mopups.Services.MopupService.Instance.Popped += Mopups_Popped;
	}

	private void Mopups_Popped(object? sender, PopupNavigationEventArgs e)
	{
		
	}

	private void Mopups_Pushed(object? sender, PopupNavigationEventArgs e)
	{
